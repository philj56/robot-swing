...
public:
	...
	*/
	...
	/**
	* @brief Constructor for priority queue to pass data with priorities initially.
	*
	...
	*/
	PriorityQueue(const PriorityQueue<T, PT>& copyQueue) {
		heapType = copyQueue.heapType;
		dataWithPriorityVec = copyQueue.dataWithPriorityVec;
	}
