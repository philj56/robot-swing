	...
	: AL::ALModule(broker, name)
{
	...
	// Arrays of names and angles for joints to move
	// Commented out upper body movement, due to broken right arm -
	// uncomment these to restore movement
	...
	// Initialise vectors from arrays
...
// Move to forwards sitting position
// Right arm set to 0 stiffness as it broke - can be removed once fixed
...
// Move to part way between forwards and backwards sitting position
// Right arm set to 0 stiffness as it broke - can be removed once fixed
...
// Move according to human motion fit
// Right arm set to 0 stiffness as it broke - can be removed once fixed
...
// Empirical human motion positions from 4-th order polynomials
// Uncomment result.push_back(body) lines once right arm is fixed
