motiontiming - call a shared library module locally on the robot
...
To use:
	...
	now cross compile motiontiming for the robot, and copy it over

		cd {git path}/sdk/motiontiming
		
		qibuild configure -c {cc toolchain}
		qibuild make -c {cc toolchain}

		scp ./build-{cc toolchain}/sdk/bin/motiontiming nao@{NAO IP}:
